...
typedef enum { SYM_METRIC, SYM_RECOGNIZER, SYM_GENERATOR, SYM_STRING_VAR, SYM_THREAD, SYM_FUTURE } SymbolType;
...
void add_generator(PathGenerator *g);
...
extern std::vector<PathGenerator*> generators;
